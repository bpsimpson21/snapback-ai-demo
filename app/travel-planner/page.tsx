...
function Pill({ children, color = "gray" }: { children: React.ReactNode; color?: "gray" | "green" | "yellow" | "red" | "blue" }) {
  const colors = {
    gray: "border-white/10 text-gray-400",
    green: "border-emerald-400/30 text-emerald-400",
    yellow: "border-snap-yellow/40 text-snap-yellow",
    red: "border-red-400/30 text-red-400",
    blue: "border-blue-400/30 text-blue-400",
  };
  return (
    <span className={`text-[10px] font-bold uppercase tracking-widest border px-2 py-0.5 rounded-full ${colors[color]}`}>
      {children}
    </span>
  );
}
    ...
    <main className="flex-1">
      <div className="max-w-5xl mx-auto px-6 py-12 space-y-16">
          ...
          <div className="flex items-start justify-between gap-4 mb-8">
            <div>
              ...
              <p className="text-gray-400 text-sm leading-relaxed max-w-2xl mb-3">
                Demo: What an AI-powered trip planner looks like in practice. This is a
                real scenario — the Jaguars announced back-to-back London games on Feb 25,
                2026. Below is what the AI planner generates from a single input brief.
              </p>
          ...
          <div className="border border-white/10 rounded-2xl bg-white/5 p-6 sm:p-8">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-4">
              {[
                ...
                { label: "Arrival", value: "Thu, October 1, 2026" },
                { label: "Departure", value: "Tue, October 13, 2026" },
                { label: "Duration", value: "13 days / 12 nights" },
                { label: "Budget", value: "$8,000 – $12,000 total" },
              ].map((f) => (
                <div key={f.label} className="border-b border-white/5 pb-3">
            ...
            <div className="mt-5 border-b border-white/5 pb-3">
              <p className="text-[10px] font-bold uppercase tracking-widest text-gray-600 mb-1">
                Purpose
              </p>
              <p className="text-sm text-white font-medium">
                Cover Jaguars London games — back-to-back weeks at Tottenham Hotspur
                Stadium (Oct 4) and Wembley Stadium (Oct 11)
              </p>
            </div>
            ...
            <div className="mt-5">
              ...
              <p className="text-sm text-gray-400 leading-relaxed">
                Need to shoot content day before each game + game day. Rest/edit days in
                between.
              </p>
            </div>
          </div>
        ...
        <FadeIn>
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2 text-[10px] text-gray-600">
              ...
              Generated in 3.2s &nbsp;·&nbsp; Feb 25, 2026 at 2:14 PM
            </div>
          </div>
        </FadeIn>
        ...
        <div className="space-y-4">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="border border-white/10 rounded-xl bg-white/[0.02] p-4">
                  ...
                  <p className="text-xs text-gray-400 leading-relaxed">
                    Departs ~6:00 PM, arrives Fri Oct 2 ~7:00 AM (overnight). British Airways direct
                    or Delta/United with one connection.
                  </p>
                </div>
                <div className="border border-white/10 rounded-xl bg-white/[0.02] p-4">
                  <div className="flex items-center justify-between mb-3">
                  ...
                  <p className="text-xs text-gray-400 leading-relaxed">
                    Departs ~10:00 AM, arrives ~4:00 PM same day (time zone gain).
                    Same carrier options.
                  </p>
                </div>
              </div>
          ...
          <Section icon="🏨" title="Accommodation" defaultOpen delay={50}>
            <div className="space-y-4">
              <p className="text-sm text-gray-400 leading-relaxed">
                ...
                — well-connected by Tube to both Tottenham Hotspur Stadium (Victoria line or
                Overground to White Hart Lane) and Wembley (Metropolitan/Jubilee line to Wembley Park).
              </p>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="border border-white/10 rounded-xl bg-white/[0.02] p-4">
                  ...
                  <p className="text-xs text-gray-400 leading-relaxed mb-3">
                    Mid-range chain — Premier Inn, Travelodge, or Holiday Inn near King&apos;s Cross.
                  </p>
                ...
                <div className="border border-emerald-400/20 rounded-xl bg-emerald-500/5 p-4">
                  ...
                  <p className="text-xs text-gray-400 leading-relaxed mb-3">
                    2-bedroom flat in Islington or Camden. Kitchen for meals, space to edit footage.
                  </p>
                  <div className="border-t border-white/5 pt-3 space-y-1">
              ...
              <div className="border border-emerald-400/20 bg-emerald-500/5 rounded-xl p-4">
                ...
                <p className="text-sm text-gray-300 leading-relaxed">
                  Airbnb for extended stay — cost savings of $600–$900, plus kitchen for meals and
                  dedicated space to review/edit footage between shoot days.
                </p>
              </div>
            </div>
          </Section>
          ...
          <Section icon="🚇" title="Transportation" delay={100}>
            <div className="space-y-4">
              <div className="border border-red-400/20 rounded-xl bg-red-500/5 p-4">
                ...
                <p className="text-xs text-gray-400 leading-relaxed">
                  Congestion charge £15/day in central London. Parking is expensive and scarce.
                  Narrow streets, left-hand traffic. Would cost ~$2,000+ for 12 days
                  including fuel, insurance, and parking. <span className="text-red-400 font-medium">AI flags this as a cost trap.</span>
                </p>
              </div>
              ...
              <div className="border border-emerald-400/20 rounded-xl bg-emerald-500/5 p-4">
                ...
                <p className="text-xs text-gray-400 leading-relaxed mb-3">
                  Pay-as-you-go on all Tube, bus, and Overground lines. Daily cap ~£8.10/person.
                  Covers travel to both stadiums.
                </p>
          ...
          <Section icon="🏟️" title="Game Tickets" delay={150}>
            <div className="space-y-4">
              ...
              <div className="border border-emerald-400/20 bg-emerald-500/5 rounded-xl p-4">
                ...
                <p className="text-sm text-gray-300 leading-relaxed">
                  Snapback should apply through NFL Communications for press credentials 6–8
                  weeks before game day. If approved, ticket cost = $0 and you get media
                  access (field level, press box, mixed zone).
                </p>
              </div>
          ...
          {/* Content Shooting Locations */}
          <Section icon="🎥" title="Content Shooting Locations" delay={200}>
            <div className="space-y-5">
              <div>
                <div className="flex items-center gap-2 mb-3">
                  <Pill color="yellow">Week 1</Pill>
                  <p className="text-sm font-semibold text-white">Tottenham Area — Oct 2–4</p>
                </div>
                <ul className="space-y-1.5">
              ...
              <div>
                <div className="flex items-center gap-2 mb-3">
                  <Pill color="yellow">Week 2</Pill>
                  <p className="text-sm font-semibold text-white">Wembley Area — Oct 9–11</p>
                </div>
                <ul className="space-y-1.5">
              ...
              <div>
                <div className="flex items-center gap-2 mb-3">
                  <Pill>Between Games</Pill>
                  <p className="text-sm font-semibold text-white">Oct 5–8 — Rest / Edit / B-Roll</p>
                </div>
                <ul className="space-y-1.5">
          ...
          <Section icon="🛡️" title="Area Safety Briefing" delay={300}>
            <div className="space-y-4">
              {[
                {
                  area: "Central London (King's Cross / Islington / Camden)",
                  status: "Safe",
                  statusColor: "green" as const,
                  detail:
                    "Generally safe. Standard city awareness — watch for pickpockets on Tube and in crowds. Well-lit, well-policed, heavy foot traffic at all hours.",
                },
                {
                  area: "Tottenham (N17)",
                  status: "Safe on Game Day",
                  statusColor: "yellow" as const,
                  detail:
                    "Stadium area is heavily policed on game days. Stick to main roads and the stadium precinct. Some surrounding residential areas are rougher — no need to wander far from the ground.",
                },
                {
                  area: "Wembley (HA9)",
                  status: "Safe",
                  statusColor: "green" as const,
                  detail:
                    "Very safe on game days, heavily staffed. Olympic Way is a controlled corridor. Area around Wembley Central station is fine but unremarkable.",
                },
              ].map((loc) => (
              ...
              <div className="border border-white/10 rounded-xl bg-white/[0.02] p-4">
                <p className="text-xs font-bold uppercase tracking-widest text-gray-500 mb-3">General Safety Notes</p>
                <ul className="space-y-1.5">
            ...
            <div className="space-y-4">
              ...
              <div className="border border-emerald-400/20 bg-emerald-500/5 rounded-xl p-4">
                <p className="text-sm text-gray-300 leading-relaxed">
                  ...
                  Remaining $0–$6,940 available for equipment rental, premium ticket
                  upgrades, or emergency expenses.
                </p>
              </div>
            </div>
          </Section>
          ...
          <div className="text-center pt-4 pb-8">
            <div className="inline-flex items-center gap-2 border border-white/10 rounded-full px-4 py-2 bg-white/5">
              ...
              <span className="text-xs text-gray-500">
                Generated by AI Travel Planner &nbsp;·&nbsp; Snapback AI Ops Lab
              </span>
            </div>
          </div>
        </FadeIn>
